<footer class="bg-slate-900 py-12 border-t border-white/5">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <!--
        <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div class="col-span-1 md:col-span-2">
                <h3 class="text-xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-{{ $primaryColor ?? 'purple' }}-400 to-pink-500">AniVel</h3>
                <p class="mt-3 text-gray-400">Your journey to mastering animation and level design starts here. Explore our comprehensive lessons and tutorials.</p>
            </div>
            <div>
                ...
                <ul class="mt-4 space-y-2">
                    ...
                    <li><a href="#" class="text-gray-300 hover:text-white transition-colors">Tutorials</a></li>
                    <li><a href="#" class="text-gray-300 hover:text-white transition-colors">Community</a></li>
                </ul>
            </div>
            <div>
                <h4 class="text-sm font-semibold uppercase tracking-wider text-gray-400">Company</h4>
                <ul class="mt-4 space-y-2">
        ...
        <div class="mt-12 pt-8 border-t border-white/10 flex flex-col md:flex-row justify-between items-center">
            <p class="text-gray-400 text-sm">© 2025 AniVel. All rights reserved.</p>
